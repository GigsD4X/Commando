...
class CommandoClient extends discord.Client {
	 ...
	 * @property {boolean} [missingPermissionsResponse=false] - Whether the bot should respond to an unauthorized command
	...
	constructor(options = {}) {
		...
		if(typeof options.missingPermissionsResponse === 'undefined') options.missingPermissionsResponse = false;
		super(options);
